...
<h3 id="myHeader"><button id="button2" onclick="location.href='view-sale.htm'" type="button">AnunturileMeleVanzare</button><button id="button2" onclick="location.href='administrare-locatii.htm'" type="button">AnunturileMeleCumparare</button><button id="button2" onclick="location.href='administrare-locatii.htm'" type="button">MyBlackList</button><button id="button2" onclick="location.href='administrare-locatii.htm'" type="button">MyForumList</button>  </h3>
